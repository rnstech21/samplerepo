                ...
                <div class="card-body LoginBg paddingLftRt30Rt0" style="border-right:1px solid #3c5a9a;">
                    <div >
                        ...
                        <div >                                
                            ...
                            <span class="LoginHead" ><font  style="text-align: center; padding-left: 200px;">Congratulations!</font></span>
                            <br/>
                            
                            <br>
                            <font color="#12b0e0" style="text-align: left;padding-left: 50px; ">
                            <b>Hello <font style="text-transform: capitalize;">${firstname} ${lastname},</font></b>   <br/>  </font>
                            <font color="#12b0e0" style="text-align: left;padding-left: 50px; ">Your password has  been changed successfully.  </font><br>
                            <font color="#12b0e0" style="text-align: left;padding-left: 50px; "> Click on the above link to go to login page.</font>
