                ...
                <div class="card-body LoginBg paddingLftRt30Rt0" style="border-right:1px solid #3c5a9a;">
                    <div >
                        ...
                        <div class="col-xs-8">                                
                            ...
                            <span class="LoginHead" ><font  style="text-align: center; padding-left: 200px;">Forgot Password</font></span>
                            <br/>
                            ...
                            <form:form method="POST" class="form floating-label" action="passrecovery" accept-charset="utf-8" modelAttribute="recoveryForm">
                            <form class="form floating-label" action="html/dashboards/dashboard.html" accept-charset="utf-8" method="post">
                                ...
                                <div>
                                    ...
                                    <form:input path="reEmail" class="form-control" placeholder="Registered Email Id"/>
                                    <font color="red"> <form:errors path="reEmail"></form:errors></font>
