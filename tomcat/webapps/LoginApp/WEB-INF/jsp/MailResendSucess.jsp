                ...
                <div class="card-body LoginBg paddingLftRt30Rt0" style="border-right:1px solid #3c5a9a;">
                    <div >
                        ...
                        <div >                                
                            ...
                            <span class="LoginHead" ><font  style="text-align: center; padding-left: 200px;">Link has been sent successfully!</font></span>
                            <br/>
                            <br>
                            <br>
                            <br>
                            <font color="#12b0e0" style="text-align: left; ">
                            <b>Hello <font style="text-transform: capitalize;">${registrationForm.firstName} ${registrationForm.lastName},</font></b> <br/>Congratulations!!  <br/>Link is successfully sent to your Email.
                            You are just one step away to start assessments. <br/>
                           You will receive an email with activation link. 
                           Please click on the link in the mail to get your account activated.
